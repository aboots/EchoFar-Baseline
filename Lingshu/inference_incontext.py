...
OUTPUT_PATH = Path("/home/mahdi.abootorabi/EchoFAR/results_lingshu_incontext.json")
...
def main():
    ...
    for exam_id in tqdm(to_process_ids, desc="Generating ICL reports"):
        try:
            ...
            for i, ex in enumerate(ic_examples):
                ...
                for j, v_arr in enumerate(ex["videos"]):

...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--ground-truth-csv",
        type=str,
        default="/home/mahdi.abootorabi/EchoFAR/groudtruth_feb21.csv",
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="/home/mahdi.abootorabi/EchoFAR/classification_eval",
...
def evaluate(
    ...
    # Create a subdirectory for this specific prediction file
    actual_output_dir = output_dir / predicted_csv.stem
    ...
    per_concept_csv_path = actual_output_dir / "per_concept_metrics.csv"
    per_concept_df.to_csv(per_concept_csv_path, index=False)

    overall_json_path = actual_output_dir / "overall_metrics.json"
    ...
    if aligned_export_rows is not None:
        aligned_csv_path = actual_output_dir / "aligned_normalized_gt_pred.csv"

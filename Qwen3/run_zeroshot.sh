...
echo "Starting Echo Zero-Shot Inference at $(date)"
echo "Job ID: $SLURM_JOB_ID"

# Run the inference script
python /home/mahdi.abootorabi/EchoFAR/inference_zeroshot.py

echo "Finished Echo Zero-Shot Inference at $(date)"

...
BASE_MODEL_ID = "ddvd233/QoQ-Med-VL-7B"
...
def main():
    parser = argparse.ArgumentParser(description="Inference with finetuned QoQ-Med on test set")
    parser.add_argument(
        "--adapter_path",
        type=str,
        default="/home/mahdi.abootorabi/EchoFAR/qoq_med_finetuned/checkpoint-best",
    ...
    parser.add_argument(
        ...
        default="/home/mahdi.abootorabi/EchoFAR/results_qoq_med_finetuned.json",
    )
    ...
    for exam_id in tqdm(to_process_ids, desc="Finetuned QoQ-Med inference"):
        try:
    ...
    print("\n--- Finetuned QoQ-Med Test Metrics ---")
